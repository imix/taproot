...
## Open Questions
- The `requirements-hierarchy/intent.md` constraint "framework files (skills, config) live in `.taproot/`" should be updated to reflect the new layout — deferred to a follow-up spec refinement (`/tr-refine`).
