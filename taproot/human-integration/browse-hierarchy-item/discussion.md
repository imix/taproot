...
**Should this merge with `/tr-review`?**
...
"explain" was rejected (too instructional — it implies the agent explains, not the human reads). "review" was taken. "walk" was proposed but the developer didn't like it. "browse" landed — it implies navigation and reading without judgment, and distinguishes itself from the agent-driven `/tr-review`.
...
- **Merge with `/tr-review`** — rejected; developer doesn't always want agent critique before reading
...
Single new skill `/tr-browse` — paginated section-by-section reading with [C]/[M] at each step, discussion.md context shown inline, children listed at the end without auto-descent. Stays clearly distinct from `/tr-review` (agent critique) and `/tr-review-all` (bulk critique).
