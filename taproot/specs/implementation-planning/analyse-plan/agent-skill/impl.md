...
- condition: check-if-affected-by: human-integration/contextual-next-steps | note: compliant — skill ends with a What's next? block offering /tr-plan-execute (natural next step after analysis) and /tr-plan (to add more items) | resolved: 2026-03-27
