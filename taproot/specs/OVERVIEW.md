...
- **[cursor-plugin](./agent-integration/cursor-plugin/usecase.md)** `[specified]` — Actor: Developer using Cursor IDE who wants taproot's requirement workflow available natively through Cursor's plugin system
...
- **[portable-output-patterns](./agent-integration/portable-output-patterns/usecase.md)** `[specified]` — Actor: Skill author writing or maintaining a taproot skill file (`skills/*.md`)
