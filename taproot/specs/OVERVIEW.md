...
- **[agent-capability-invocation](./agent-integration/agent-capability-invocation/usecase.md)** `[specified]` — Actor: Skill author — writing or updating a taproot skill file (`skills/*.md`) that needs to trigger an agent-native capability (such as context compression) without naming a specific agent or its mechanism.
...
- **[neutral-dod-resolution](./skill-architecture/neutral-dod-resolution/usecase.md)** `[specified]` — Actor: Skill author — writing or updating a taproot skill file that includes DoD resolution steps.
...
---
21 intents · 131 behaviours · 109 implementations · 107/109 complete
