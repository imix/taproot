...
- **[define-cross-repo-link](./cross-repo-specification/define-cross-repo-link/usecase.md)** `[specified]` — Actor: Developer in a linking repo
  - [agent-skill](./cross-repo-specification/define-cross-repo-link/agent-skill/impl.md) `[needs-rework]` (2 commits ⚠ no tests)
...
- **[signal-cross-repo-change](./cross-repo-specification/signal-cross-repo-change/usecase.md)** `[specified]` — Actor: Developer
  - [docs-pattern](./cross-repo-specification/signal-cross-repo-change/docs-pattern/impl.md) `[complete]` (2 commits ⚠ no tests)
...
- **[enforce-spec-abstraction](./requirements-hierarchy/enforce-spec-abstraction/usecase.md)** `[specified]` — Actor: Developer or agent authoring or committing a spec file (`intent.md` or `usecase.md`)
...
---
19 intents · 94 behaviours · 91 implementations · 88/91 complete
