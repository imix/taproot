...
- **[agent-capability-invocation](./agent-integration/agent-capability-invocation/usecase.md)** `[implemented]` — Actor: Skill author — writing or updating a taproot skill file (`skills/*.md`) that needs to trigger an agent-native capability (such as context compression) without naming a specific agent or its mechanism.
  - [multi-surface](./agent-integration/agent-capability-invocation/multi-surface/impl.md) `[complete]` (2 commits, 1 test)
...
- **[bug-triage](./human-integration/bug-triage/usecase.md)** `[implemented]` — Actor: Developer or AI coding agent who has observed a defect — unexpected system behaviour, a failing test, or a user-reported issue
  - [agent-skill](./human-integration/bug-triage/agent-skill/impl.md) `[complete]` (4 commits, 1 test)
...
- **[neutral-dod-resolution](./skill-architecture/neutral-dod-resolution/usecase.md)** `[implemented]` — Actor: Skill author — writing or updating a taproot skill file that includes DoD resolution steps.
  - [multi-surface](./skill-architecture/neutral-dod-resolution/multi-surface/impl.md) `[complete]` (2 commits ⚠ no tests)
...
- **[architecture](./taproot-modules/architecture/usecase.md)** `[implemented]` — Actor: Developer (team lead or contributor) setting up architecture quality guidance for a project
  ...
  - **[define-architectural-style](./taproot-modules/architecture/define-architectural-style/usecase.md)** `[specified]` — Actor: Developer setting up architecture quality guidance for a project
    - [agent-skill](./taproot-modules/architecture/define-architectural-style/agent-skill/impl.md) `[complete]` (2 commits, 2 tests)
- **[defensive-coding](./taproot-modules/defensive-coding/usecase.md)** `[specified]` — Actor: Developer (team lead or contributor) setting up defensive coding guidance for a project
...
---
21 intents · 132 behaviours · 111 implementations · 109/111 complete
