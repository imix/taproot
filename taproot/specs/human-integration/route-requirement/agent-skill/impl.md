...
- `taproot/agent/skills/ineed.md` — installed copy
- `skills/behaviour.md` — extended with Step 0a global truth check (mirrors /tr-ineed Step 0); catches global truths when /tr-behaviour is called directly
- `taproot/agent/skills/behaviour.md` — installed copy
...
- `b1a2064007a77715738d76d41a95fc6dcf1cf13f` — (auto-linked by taproot link-commits)
- `982ae4f59ff1cf449dc1648c5077469e674e9740` — (auto-linked by taproot link-commits)
...
- condition: check-if-affected-by: agent-integration/portable-output-patterns | note: COMPLIANT — Step 0a uses the confirmation pattern format (question block + [A]/[B] option letters) as defined in skill-output-patterns.md. No agent-specific rendering instructions. Same format as /tr-ineed Step 0 which passed this check. | resolved: 2026-04-10T09:21:36.122Z
