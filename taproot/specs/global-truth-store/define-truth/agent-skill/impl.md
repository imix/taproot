...
- `taproot/agent/skills/define-truth.md` — synced copy for agent use
...
## Tests
- `test/integration/define-truth.test.ts` — covers AC-1 (suffix convention), AC-2 (sub-folder convention), AC-5 (unscopable file defaults to intent with warning), AC-6 (conflicting scope signals), and structural requirements (skill exists, has description ≤50 tokens, has What's next?, synced to taproot/agent/skills/)
...
- condition: check-if-affected: skills/guide.md | note: Added /tr-define-truth to the slash commands table in skills/guide.md and synced to taproot/agent/skills/guide.md. | resolved: 2026-03-26T15:06:56.312Z
