...
21. pending  [refine]    hitl  taproot/specs/implementation-planning/execute-plan/usecase.md  "enrich plan-execute item display: add usecase title and one-line goal to the Next: prompt so developer can make an informed proceed/skip decision"
22. pending  [refine]    hitl  taproot/specs/agent-integration/parallel-agent-execution/usecase.md  "revise spec for worktree-first model: acknowledge worktree as primary path, narrow advisory locking to shared-fs edge case"
