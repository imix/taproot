...
22. skipped  [refine]    hitl  taproot/specs/agent-integration/parallel-agent-execution/usecase.md  "revise spec for worktree-first model: acknowledge worktree as primary path, narrow advisory locking to shared-fs edge case — deferred post-v1"
