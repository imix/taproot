...
_Built: 2026-03-27 — 7 items — Goal: release readiness (VS Code, release channels, docs, DoD quality, plan execution)_

## Items

1. pending  [spec]      "other release channels — spec taproot-distribution behaviour(s) for GitHub Releases, Cursor marketplace, Homebrew, etc.; decide which channels to target for v1.0"
2. pending  [refine]    taproot/specs/taproot-distribution/vscode-marketplace/usecase.md — impl is 'deferred'; refine spec to confirm scope and unblock implementation
...
4. pending  [implement] taproot/specs/taproot-distribution/vscode-marketplace/ — resume VS Code extension implementation (currently deferred)
