...
5.  pending  [implement] hitl  "fix author-design-constraints/agent-skill/impl — skills/design-constraints.md never created; mark needs-rework"
...
8.  pending  [spec]      hitl  "spec: .taproot/ gitignore boundary — truth-check-session committed, repos.yaml per-machine; design solution (move session file to taproot/? standardise .taproot/.gitignore?)"
