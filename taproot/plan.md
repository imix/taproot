...
19. pending  [implement] afk   taproot/specs/taproot-distribution/homebrew-tap/ — implement Homebrew formula + CI update job
20. pending  [implement] afk   "update skills/commit.md — add explicit document-current resolution guidance: read docs/ content, compare against git diff, prohibited shortcuts listed; mirrors the spec prohibition"
