...
30. pending  [refine]    hitl  cross-repo-specification/intent  "SC-4 gap: cross-repo truth enforcement not behaviourised — add behaviour or explicitly defer to v2 with backlog entry"
31. pending  [refine]    hitl  cross-repo-specification/intent  "SC-5 gap: delegated impl state not behaviourised — add behaviour or defer; add 'delegated' to allowed_impl_states"
