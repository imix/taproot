...
12. done     [spec+impl] hitl  "ux: add /tr-browse option to spec-authoring skills — /tr-behaviour, /tr-refine, /tr-intent should offer 'browse related context' as a next step or inline option when writing/refining a spec"
