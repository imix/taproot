...
22. done     [implement] afk   "rename commands: /tr-plan → /tr-next, /tr-plan-build → /tr-plan; update .claude/commands/, skills/, guide.md, docs/agents.md, all cross-references in specs and docs"
23. done     [implement] afk   taproot/specs/quality-gates/definition-of-done/ — implement step 0 uncommitted changes gate in taproot dod CLI: git status diff, out-of-scope detection, [C]/[S]/[I]/[A] prompt
