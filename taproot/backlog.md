...
- [2026-04-09] BUG: What's next menus in skills still show full paths (taproot/specs/human-integration/...) instead of abbreviated paths (human-integration/...) — the ux-principles truth "Abbreviated hierarchy paths" rule is not being followed; affects at least /tr-behaviour What's next output; strip taproot/specs/ prefix and .md extension in all skill output paths
