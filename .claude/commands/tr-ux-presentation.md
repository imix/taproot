---
name: 'tr-ux-presentation'
description: 'Elicit and capture presentation UX conventions for the project: layout structure, information hierarchy signals, density defaults, progressive disclosure, and collection display choices'
---
...
<steps CRITICAL="TRUE">
1. LOAD the FULL skill file at @{project-root}/taproot/agent/skills/ux-presentation.md
