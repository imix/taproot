---
name: 'tr-behaviour'
description: 'Define a UseCase (observable system behaviour) under an intent or another behaviour'
---
...
<steps CRITICAL="TRUE">
1. LOAD the FULL skill file at @{project-root}/taproot/agent/skills/behaviour.md
