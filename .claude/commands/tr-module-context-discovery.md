---
name: 'tr-module-context-discovery'
description: 'Establish the project context record used by all quality modules: product type, target audience, and quality goals'
---
...
<steps CRITICAL="TRUE">
1. LOAD the FULL skill file at @{project-root}/taproot/agent/skills/module-context-discovery.md
