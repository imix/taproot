---
name: 'tr-arch-error-handling'
description: 'Elicit and capture error handling strategy conventions for the project: where errors are caught, how they propagate, and what the standard recovery and reporting patterns are'
---
...
<steps CRITICAL="TRUE">
1. LOAD the FULL skill file at @{project-root}/taproot/agent/skills/arch-error-handling.md
