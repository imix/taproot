---
name: 'tr-security-periodic-review'
description: 'Two modes: **setup** — elicit the periodic security review checklist and cadence, write `security-periodic-review_behaviour.md`; **run** — execute the review against the configured checklist, surface findings, and update last-reviewed dates'
---
...
<steps CRITICAL="TRUE">
1. LOAD the FULL skill file at @{project-root}/taproot/agent/skills/security-periodic-review.md
