---
name: 'tr-ux-visual'
description: 'Elicit and capture visual language conventions for the project: colour palette, semantic colour tokens, dark/light mode rules, icon set selection, iconography style, and sizing conventions'
---
...
<steps CRITICAL="TRUE">
1. LOAD the FULL skill file at @{project-root}/taproot/agent/skills/ux-visual.md
