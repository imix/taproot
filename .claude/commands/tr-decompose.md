---
name: 'tr-decompose'
description: 'Break an intent down into the set of behaviours (UseCases) needed to fulfill it'
---

IT IS CRITICAL THAT YOU FOLLOW THESE STEPS EXACTLY:

<steps CRITICAL="TRUE">
1. LOAD the FULL skill file at @{project-root}/taproot/agent/skills/decompose.md
