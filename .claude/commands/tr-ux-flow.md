---
name: 'tr-ux-flow'
description: 'Elicit and capture flow UX conventions for the project: navigation model, multi-step task sequences, cancellation behaviour, and destructive-action confirmation gates'
---
...
<steps CRITICAL="TRUE">
1. LOAD the FULL skill file at @{project-root}/taproot/agent/skills/ux-flow.md
