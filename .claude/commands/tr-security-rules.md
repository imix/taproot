...
description: 'Elicit and capture secure coding conventions for the project across 9 rule categories'
---
...
<steps CRITICAL="TRUE">
1. LOAD the FULL skill file at @{project-root}/taproot/agent/skills/security-rules.md
