---
name: 'tr-ux-feedback'
description: 'Elicit and capture feedback UX conventions for the project: success/error/warning hierarchy, loading states, inline vs global error placement, and partial-outcome handling'
---
...
<steps CRITICAL="TRUE">
1. LOAD the FULL skill file at @{project-root}/taproot/agent/skills/ux-feedback.md
