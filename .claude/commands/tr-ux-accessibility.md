---
name: 'tr-ux-accessibility'
description: 'Elicit and capture accessibility UX conventions for the project: keyboard model, focus management, contrast targets, motion preferences, labelling, and live region announcements'
---
...
<steps CRITICAL="TRUE">
1. LOAD the FULL skill file at @{project-root}/taproot/agent/skills/ux-accessibility.md
