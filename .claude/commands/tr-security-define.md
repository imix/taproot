---
name: 'tr-security-define'
description: 'Activate the security quality module: establish project context, scan for existing coverage across 5 layers, walk through each layer via sub-skills, and optionally wire a DoD condition so agents apply security conventions automatically'
---
...
<steps CRITICAL="TRUE">
1. LOAD the FULL skill file at @{project-root}/taproot/agent/skills/security-define.md
