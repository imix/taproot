---
name: 'tr-security-hardening'
description: 'Elicit and capture the deploy-time security baseline for the project — security headers, TLS requirements, least-privilege, secrets management approach, and platform-specific hardening'
---
...
<steps CRITICAL="TRUE">
1. LOAD the FULL skill file at @{project-root}/taproot/agent/skills/security-hardening.md
