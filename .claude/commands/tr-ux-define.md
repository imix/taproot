---
name: 'tr-ux-define'
description: 'Activate the user-experience quality module: scan for existing UX coverage, walk through each of the 10 UX aspects, elicit conventions via sub-skills, and optionally wire a DoD condition so agents apply UX conventions automatically'
---
...
<steps CRITICAL="TRUE">
1. LOAD the FULL skill file at @{project-root}/taproot/agent/skills/ux-define.md
