---
name: 'tr-ux-consistency'
description: 'Elicit and capture consistency UX conventions for the project: shared-pattern vocabulary, deviation documentation, cross-surface alignment rules, and criteria for introducing new patterns'
---
...
<steps CRITICAL="TRUE">
1. LOAD the FULL skill file at @{project-root}/taproot/agent/skills/ux-consistency.md
