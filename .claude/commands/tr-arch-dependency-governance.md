---
name: 'tr-arch-dependency-governance'
description: 'Capture dependency governance conventions for the project: the rule that no dependency may be added without developer consent'
---
...
<steps CRITICAL="TRUE">
1. LOAD the FULL skill file at @{project-root}/taproot/agent/skills/arch-dependency-governance.md
