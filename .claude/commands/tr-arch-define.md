---
name: 'tr-arch-define'
description: 'Activate the architecture quality module: scan for existing architecture convention coverage, walk through each of the 7 aspects, elicit conventions via sub-skills, and optionally wire DoD and DoR conditions'
---
...
<steps CRITICAL="TRUE">
1. LOAD the FULL skill file at @{project-root}/taproot/agent/skills/arch-define.md
