---
name: 'tr-security-ci-cd'
description: 'Elicit and configure which security gates run in the CI/CD pipeline — which tools, which trigger, and whether findings block the pipeline or warn only'
---
...
<steps CRITICAL="TRUE">
1. LOAD the FULL skill file at @{project-root}/taproot/agent/skills/security-ci-cd.md
