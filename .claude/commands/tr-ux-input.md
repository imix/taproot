---
name: 'tr-ux-input'
description: 'Elicit and capture input UX conventions for the project: validation timing, required/optional signalling, default values, keyboard affordances, and destructive-input confirmation'
---
...
<steps CRITICAL="TRUE">
1. LOAD the FULL skill file at @{project-root}/taproot/agent/skills/ux-input.md
